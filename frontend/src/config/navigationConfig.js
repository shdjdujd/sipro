  ...
  },
  {
    ...
    items: [
      ...
      { id: "inbox", label: "Percakapan (WA)", icon: MessagesSquare, path: "/inbox",
        roles: SALES_SIDE },
      // Belum dibangun (Fase 42+): tanpa `path` sama sekali supaya mustahil menjadi
      // route mati — pemakai melihat kunci, bukan halaman kosong.
      { id: "partners", label: "Mitra & Fee", icon: Handshake, roles: SALES_SIDE,
        comingSoon: true, note: "Aturan fee mitra & tagihan fee — Fase 42" },
    ],
  },
  {
    type: "group", groupId: "marketing", label: "Marketing", roles: OMNI_SIDE,
    items: [
      { id: "automation", label: "Automasi & Channel", icon: Workflow, path: "/automation",
        roles: OMNI_SIDE },
      { id: "campaigns", label: "Kampanye & Biaya Iklan", icon: Megaphone, roles: OMNI_SIDE,
        comingSoon: true, note: "Biaya iklan per kampanye & CPL — Fase 44" },
      { id: "attribution", label: "Atribusi & CAPI", icon: Target, roles: OMNI_SIDE,
        comingSoon: true, note: "Atribusi lead ke kampanye (kini di Automasi) — Fase 44" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { id: "bi", label: "Analitik & BI", icon: BarChart3, roles: ALL, comingSoon: true,
        note: "Eksekutif, Penjualan & Lead, Marketing, Proyek & Biaya, Kinerja Tim — Fase 45" },
    ],
  },
  {
